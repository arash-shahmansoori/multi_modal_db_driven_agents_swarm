...
def agent_loop_anlys_with_func(
    ...
    Args:
        ...
        path_name (str): The path name to the generated content to analyze
        file_name (str): The file name of the generated content to analyze
                    ...
                    match function_name:
                        case func.__name__:
                            new_arguments = {
                                ...
                                if key not in ["path_name", "file_name"]
                            }

                            response = func(path_name, file_name, **new_arguments)
